...
### Perguntas:
1- Qual o seu nível de satisfação com a monitoria? 9/10

2- O quanto você acha esse projeto relevante para o dia a dia escolar? 8/10

3- Quão revolucionario você acha o projeto? 6/10 

4- Qual seu nivel de satisfação com relação aos jogos? 6/10

5- Você sentiu que o projeto foi inclusivo e atendeu as necessidades de diferentes tipos de pessoas? 5/10
